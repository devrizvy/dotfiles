...
# ⛵ Go to webDevelopment folder only when NOT in VS Code
if [[ "$TERM_PROGRAM" != "vscode" ]]; then
  # echo "🧭 Launching outside VS Code — navigating to ~/webDevelopment"
  cd ~/webDevelopment
else
  # echo "💼 Launching inside VS Code — staying in project directory"
fi
